...
| [Archillect Downloader](https://github.com/TheLastZombie/loaders/blob/master/loaders/Archillect%20Downloader.js) | ✕ ([axios](https://github.com/axios/axios)) | | ✕ |
...
| [Emoji Downloader](https://github.com/TheLastZombie/loaders/blob/master/loaders/Emoji%20Downloader.js) | ✕ ([axios](https://github.com/axios/axios)) | | ✕ |
...
| [Heritage Downloader](https://github.com/TheLastZombie/loaders/blob/master/loaders/Heritage%20Downloader.js) | ✕ ([axios](https://github.com/axios/axios), [sanitize-filename](https://github.com/parshap/node-sanitize-filename), [adm-zip](https://github.com/cthackers/adm-zip)) | | ✕ |
...
| [yiff.party Downloader](https://github.com/TheLastZombie/loaders/blob/master/loaders/yiff.party%20Downloader.js) | ✕ ([axios](https://github.com/axios/axios)) | | ✕ |
